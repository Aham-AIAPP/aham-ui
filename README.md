...
[![Release](https://img.shields.io/github/v/release/li599198347-svg/aham-ui?label=release&color=336EE8)](https://github.com/li599198347-svg/aham-ui/releases)
[![在线全景](https://img.shields.io/badge/docs-在线全景-336EE8)](https://li599198347-svg.github.io/aham-ui/)

![Aham UI — 供 AI 消费的设计系统](assets/social-preview.png)

> **把"该长什么样"写成机器可读的单一事实源，让 Claude 等 AI 工具据此产出风格一致的界面与文档。**
> aham 系列 · 本地优先 macOS AI 工具的设计地基。

把灵感交给 AI 生成交付物时，字体、颜色、间距各自为政——十几个文件十几种样式。Aham UI 把设计语言写成一份**机器可读、自洽**的规范，AI 据此产出，处处一致。
...
**v6.1** · 更新记录见 [Releases](https://github.com/li599198347-svg/aham-ui/releases) 与 [CHANGELOG.md](./CHANGELOG.md) · 参与贡献见 [CONTRIBUTING.md](./CONTRIBUTING.md) · [MIT](./LICENSE)
Aham：把灵光一现，做成能用的 AI 工具。
